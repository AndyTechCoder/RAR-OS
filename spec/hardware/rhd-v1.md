...
- Register window, 56 bytes: `parent_kind:u16`, `role:u16`, `parent_id:u32`, `address_space:u16`, `access_width:u8`, `byte_order:u8`, `stride:u16`, `flags:u16`, `base:u64`, `length:u64`, `authority_purpose:u16`, and reserved fields. `parent_kind` must be interrupt (3), timer (4), or serial (5); the ID must resolve uniquely in that kind. The authority descriptor is found by `(authority_purpose,parent_kind,parent_id)`, never by table position.
