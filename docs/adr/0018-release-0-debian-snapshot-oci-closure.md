...
Two independent acquisitions must produce identical canonical manifests and derived OCI digests; negative tests cover stale metadata, substitutions, key mismatch, closure drift, symlinks, and inode mutation.
