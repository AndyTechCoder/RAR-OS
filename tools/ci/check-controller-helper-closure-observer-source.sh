...
[ "$(sha "$workflow")" = cd11eb3ccaff96cbc1e83dfc7908585cc2c9da5d2f0c2edd822e55d803a008ae ] || fail 'workflow bytes escaped review'
...
[ "$(sha "$policy")" = 70c960bd7824662bbfda3137fbc0b7c3512bf63466ebebafd67249bc0e996429 ] || fail 'policy bytes escaped review'
[ "$(sha "$policy_test")" = 404c88f70b614cc126bf2611ae34397294733b3e6a46cb5c0214e5d0b823a144 ] || fail 'policy_test bytes escaped review'
