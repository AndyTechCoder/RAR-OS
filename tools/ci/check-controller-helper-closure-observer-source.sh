...
[ "$(sha "$workflow")" = 7c5d9dd14e0e27ecba59e497d73720ca94de35e9e15f6a93fa8f9fd33ef1a02a ] || fail 'workflow bytes escaped review'
...
[ "$(sha "$policy")" = 8dc87f29fc56c010fd9399c51577ff1a9ba4fe9303728cc7853de21b10a900a8 ] || fail 'policy bytes escaped review'
[ "$(sha "$policy_test")" = e6e9b60d34b207d669dbf94500a2a7b5e19b0820838c4473161bfe689f32814f ] || fail 'policy_test bytes escaped review'
