...
[ "$(sha "$workflow")" = 5a24e8843af2e6f365690f0809db55faef3a61fe4e0635d30404026cb25f58f1 ] || fail 'workflow bytes escaped review'
...
[ "$(sha "$policy")" = 5b381bbe8bad90a91beae067a8edc8ba9efd9cf5821e09acdace78611fe0a340 ] || fail 'policy bytes escaped review'
[ "$(sha "$policy_test")" = af25d5ae19f534954ebf6a52918f544c3aee5ba8354641a2bb83af52a8ca6be3 ] || fail 'policy_test bytes escaped review'
