...
[ "$(sha "$workflow")" = 976d81fe204bb86e0f8aa66fd0cbada8c41393320b587b6c0147feab85ae82f3 ] || fail 'workflow bytes escaped review'
...
[ "$(sha "$policy")" = f550fbaa553ccb53f1a7f6caa278377baa22d02d0ddd09cf9eea5a6d5446f884 ] || fail 'policy bytes escaped review'
[ "$(sha "$policy_test")" = fe48c21f878e473fcd772f43caea0434f912a1c12b6fd88c027ded1221b10996 ] || fail 'policy_test bytes escaped review'
