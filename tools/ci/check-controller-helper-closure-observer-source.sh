...
[ "$(sha "$policy")" = 1dba6cadf12f3eabf9e7793bb8c98dba0ce715fd2fe2c5317176b40d6cd45a61 ] || fail 'policy bytes escaped review'
[ "$(sha "$policy_test")" = e9b7c6459021893e1edb58b0d3d55215bf22c12f13cd0528226a027b91479379 ] || fail 'policy_test bytes escaped review'
