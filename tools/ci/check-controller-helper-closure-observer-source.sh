...
[ "$(sha "$workflow")" = 22545ef25d663e50408a381f19191d8ba4793b2c6079167cd3d2a9dcbe19c37e ] || fail 'workflow bytes escaped review'
...
[ "$(sha "$policy")" = 16e7c2433d7f80bed96191beee766e5ee4dd3bc187fc7fd2171de78b9a193aba ] || fail 'policy bytes escaped review'
[ "$(sha "$policy_test")" = 94e6f81cedc3d4df9713b6df69b8c3614b9667b155c5b49cb4d778b46e979751 ] || fail 'policy_test bytes escaped review'
