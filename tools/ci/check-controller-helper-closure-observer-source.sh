...
[ "$(sha "$workflow")" = 407870c3d5cb091ad26d943b71189adecf37f500ac999895ef9012097984f6d3 ] || fail 'workflow bytes escaped review'
...
[ "$(sha "$policy_test")" = eba638ef8834fdd0ae203d2ac3add73f647270bdd98c8aa1682baddc7b989ec1 ] || fail 'policy_test bytes escaped review'
