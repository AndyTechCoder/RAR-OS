...
[ "$(sha "$workflow")" = be4f9bbbb12f62e2e65695a202666e0ea513a7913ca446a720c01fb456bc6dad ] || fail 'workflow bytes escaped review'
...
[ "$(sha "$policy")" = be0c9f67a05423240e4d84beeb8ffc210a8090d2b39e7ce704381c7f3c777a2b ] || fail 'policy bytes escaped review'
[ "$(sha "$policy_test")" = 65294bed8c0186a5c9e35499aa8f2f79d56c2306b3efbd9483828ff282026cbf ] || fail 'policy_test bytes escaped review'
