...
[ "$(sha "$workflow")" = d4284f4fdcba465ffac1f8928441fd22817ad14d78236a6fac192bebc9040824 ] || fail 'workflow bytes escaped review'
...
[ "$(sha "$policy")" = 5651c29c1110552483122ffa7744c3043f4213f7e09fba08f113e18da5f019f5 ] || fail 'policy bytes escaped review'
[ "$(sha "$policy_test")" = 0ff1b5473657b005e1911e7137c6de0bb8ab650df8198522dc03f1eed33b8ebb ] || fail 'policy_test bytes escaped review'
