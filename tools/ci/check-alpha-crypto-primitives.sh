...
"$work/focused-tests"
for flags in '--cfg rar_network_service_only' '--cfg rar_network_service_only --cfg rar_network_fault_peer' '--cfg rar_network_service_only --cfg rar_network_fault_peer --cfg rar_network_peer_b' '--cfg rar_network_service_only --cfg rar_network_expiry'; do
