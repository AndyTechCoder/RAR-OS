...
[ "$plan_sha" = 8bb24f1b65427c844ef27a6f18cfd5af2e320b92e2466ea2f6fd880110e62954 ] || fail 'test-plan bytes escaped review'

for required in \
    'status=experimental-complete-source-only-inactive' \
    'execution_authority=none' \
    'coverage_status=complete-via-controller-helper-closure-verifier-cases-v0+faults-v0.fields+evidence-v0.fields,still-not-an-acceptance-instance+not-ready-for-wiring' \
    ...
    'precedence_status=50-dual-invalid-oracles-bound-in-controller-helper-closure-verifier-cases-v0,not-runtime-tested+not-acceptance-evidence' \
