...
[ "$(sha_file "$semantics")" = f31acd357fc3e6889818697776155da6a2c49b0aea20a1180a8bf7089d70b4ad ] || fail 'observation repair semantics bytes escaped review'
...
for required in \
    ...
    'remaining_status=3-non-none-repair-tokens+23-primary-families+pre-start+repair-coupled-links+required-path-symlinks+raw-name+path-alias+mount+tree+manifest-specific-primary-families+exact-base+controller+runtime-precedence+fault+evidence+verdict-remain-absent' \
