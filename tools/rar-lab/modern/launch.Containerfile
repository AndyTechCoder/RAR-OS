...
COPY fault_audit.py block_disk.py block_wire.py block_process.py vm_profile.py vm_session.py persistence.py data_provision.py data_oracle.py visual_oracle.py launch.py /opt/rar-modern/
USER 65532:65532
