...
COPY signed_runtime_launch.py signed_runtime_scenario.py signed_runtime_evidence.py mounted_error_launch.py mounted_error_scenario.py unavailable_launch.py unavailable_scenario.py fault_launch.py fault_scenarios.py fault_audit.py block_disk.py block_wire.py block_process.py vm_profile.py vm_session.py persistence.py data_provision.py data_oracle.py visual_oracle.py launch.py /opt/rar-modern/
USER 65532:65532
