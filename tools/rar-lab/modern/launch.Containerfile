...
RUN set -eu; \
    ...
    apt-get -o Dir::Etc::sourcelist=/opt/rar-sources.list -o Dir::Etc::sourceparts=- -o Acquire::Check-Valid-Until=false update; \
    DEBIAN_FRONTEND=noninteractive apt-get -o Dir::Etc::sourcelist=/opt/rar-sources.list -o Dir::Etc::sourceparts=- install --yes --no-install-recommends \
