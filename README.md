...
Gate 0 was approved on 2026-07-16. The repository is ready for initial
publication and the reviewed Release 0 implementation sequence. There is no OS
implementation yet.
...
The canonical private repository is `AndyTechCoder/RAR-OS`.
